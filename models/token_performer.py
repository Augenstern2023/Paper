"""
Take Performer as T2T Transformer (only used by T2t_vit_14 and T2t_vit_24).
"""
import math
import torch
...
class Token_performer(nn.Module):
    ...
    def single_attn(self, x):
        ...
        y = torch.einsum('bti,bni->btn', qp, kptv) / (D.repeat(1,
                                                               1, self.emb) + self.epsilon)  # (B, T, emb)/Diag
        # skip connection
