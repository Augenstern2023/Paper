...
# All rights reserved.
"""
Tranfer pretrained ASF-former to downstream dataset: CIFAR10/CIFAR100.
"""
...
parser.add_argument('--model', default='ASF_former_S', type=str, metavar='MODEL',
...
if args.resume:
    ...
    assert os.path.isdir('checkpoint_{}_{}'.format(args.dataset,args.model)), 'Error: no checkpoint directory found!'
    checkpoint = torch.load('./checkpoint_{}_{}/ckpt.pth'.format(args.dataset,args.model))
